...
from PartitioningQLearning import PartitionAssignment
from PartitioningQLearning import greedyAssignment
from PartitioningQLearning import calculateLoadBalance
from PartitioningQLearning import calculateLoadBalanceWithAverage
...
class PDQLAgent:
    def __init__(self, parallelism, maxLoad):
        ...
        self.replayMemory = deque(maxlen=5000)
    ...
    def createModel(self):
        ...
        model.add(Dense(32, activation="relu", input_shape=[self.parallelism+1]))
...
def main():
    ...
    for episode in tqdm(range(1, episodes + 1), ascii=True, unit='episodes'):
        ...
        for i in range(partitions.size):
            ...
            currentAssignment.state[0], currentAssignment.state[1], currentAssignment.state[2], partition - 1])
            ...
            newState =np.array([currentAssignment.state[0], currentAssignment.state[1], currentAssignment.state[2], nextPartition])
